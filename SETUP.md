...
tests/smoke/test_smoke.py::test_health_endpoint PASSED
tests/smoke/test_smoke.py::test_freshness_poll PASSED
tests/smoke/test_smoke.py::test_quality_checks_run PASSED
